...
## Project Structure
    ...
    ├── testapiautosetting_115906  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115906`
...
2. Clone this repo and `cd testapiautosetting_115906`
